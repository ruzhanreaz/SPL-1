...
void luDecomposition()
{
    ...
    for (int i = 0; i < matrix.rows; i++)
    {
        for (int j = 0; j < matrix.cols; j++)
        {
            printf("%-6s", modifyDouble(matrix.matrix[i][j]));
        }
        printf("\n");
    }
    drawLine();
    ...
    for (int i = 0; i < l->rows; i++)
    {
        ...
        {
            printf("%-6s", modifyDouble(l->matrix[i][j]));
        }
        printf("\n");
    }
    drawLine();
    ...
    for (int i = 0; i < u->rows; i++)
    {
        ...
        {
            printf("%-6s", modifyDouble(u->matrix[i][j]));
        }
        printf("\n");
    }
    drawLine();
...
void qrDecomposition()
{
    ...
    for (int i = 0; i < Q->rows; i++)
    {
        ...
        {
            printf("%-6s", modifyDouble(Q->matrix[i][j]));
        }
        printf("\n");
    }
    ...
    for (int i = 0; i < R->rows; i++)
    {
        ...
        {
            printf("%-6s", modifyDouble(R->matrix[i][j]));
        }
        printf("\n");
    }

...
{
    return (strcmp(str, "mean") == 0 || strcmp(str, "sort") == 0 || strcmp(str, "median") == 0 || strcmp(str, "mode") == 0 || strcmp(str, "range") == 0 || strcmp(str, "svar") == 0 || strcmp(str, "sstd") == 0 || strcmp(str, "pvar") == 0 || strcmp(str, "pstd") == 0 || strcmp(str, "cov") == 0 || strcmp(str, "corr") == 0 || strcmp(str, "max") == 0 || strcmp(str, "min") == 0);
}

int isMatrixFunction(char *str)
{
    return (strcmp(str, "det") == 0 || strcmp(str, "rrf") == 0 || strcmp(str, "inv") == 0 || strcmp(str, "tra") == 0 || strcmp(str, "rref") == 0 || strcmp(str, "rank") == 0);
}
...
int tokenize(Queue *queue, char *str)
{
    ...
    while (*str)
    {
        ...
        else if (isalpha(*str) || *str == '%' || *str == '_')
        {
            ...
            else if (modeNum == 4 && isVarExist(word))
            {
            ...
            else if (modeNum == 4 && validVar(word))
            {
                if (foundnumber)
                {
            ...
            else if (modeNum == 5 && (isMatrix(word) || strcmp(word, "I") == 0))
            {
                if (foundnumber)
                {
                    enQueue(queue, "*");
            ...
            else if (modeNum == 3 && graphVariable(word))
            {
                if (foundnumber)
                {
                    enQueue(queue, "*");
